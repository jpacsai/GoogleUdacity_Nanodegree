/*
Write a function that takes two arrays of numbers as arguments and returns only one array represents all the numbers that are 
not common between the two arrays excluding the numbers that is divisible by any number that is common between the two arrays(> 1)
...
the numbers that are not common between the two arrays are 5,5,8,3,7,8,4,4,9 but 8 and 4 are divisible by 2 which is a 
common number so they are excluded and the result would be [5,3,7,9]
